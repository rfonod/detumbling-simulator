...
subplot(7,1,7)
h1=plot(1:N_orb,t_on_orb(1,:)/3600,'o-'); grid on, hold on
h2=plot(1:N_orb,t_on_orb(2,:)/3600,'o-');
h3=plot(1:N_orb,t_on_orb(3,:)/3600,'o-');
xlabel(x_text)
ylabel('$\sum\limits_{orb} T^{on}_{orb;i}$ ','interpreter','latex')
...
subplot(2,1,2)
semilogy([t(1)/T_orb t(end)/T_orb],[p_bar_u p_bar_u],'c','linewidth',1), grid on,hold on
semilogy([t(1)/T_orb t(end)/T_orb],[p_bar_l p_bar_l],'k','linewidth',1)
semilogy(t/T_orb,P_tmb,'linewidth',1)
ylabel('$\mathbf{p}^v$','interpreter','latex')
h=legend('$\bar p_{upp}$','$\bar p_{low}$','$p^{v}_x$','$p^{v}_y$','$p^{v}_z$');
set(h,'interpreter','latex','location','northeast','orientation','horizontal')
set(h,'fontsize',15)
xlabel(x_text)
xlim([0 N_orb])
...
%% Torques
global Tres Tgg Taer Tsr
figure 
subplot(3,1,1)
plot(t/T_orb, Tres(1,:))
xlabel('T_{res}', 'interpreter', 'latex')
subplot(3,1,2)
plot(t/T_orb, Tres(2,:))
xlabel('T_{res}', 'interpreter', 'latex')
subplot(3,1,3)
...
subplot(3,1,1)
plot(t/T_orb, Tgg(1,:))
xlabel('T_{gg}', 'interpreter', 'latex')
subplot(3,1,2)
plot(t/T_orb, Tgg(2,:))
xlabel('T_{gg}', 'interpreter', 'latex')
subplot(3,1,3)
...
subplot(3,1,1)
plot(t/T_orb, Tsr(1,:))
xlabel('T_{sr}', 'interpreter', 'latex')
subplot(3,1,2)
plot(t/T_orb, Tsr(2,:))
xlabel('T_{sr}', 'interpreter', 'latex')
subplot(3,1,3)
...
subplot(3,1,1)
plot(t/T_orb, Taer(1,:))
xlabel('T_{aer}', 'interpreter', 'latex')
subplot(3,1,2)
plot(t/T_orb, Taer(2,:))
xlabel('T_{aer}', 'interpreter', 'latex')
subplot(3,1,3)
